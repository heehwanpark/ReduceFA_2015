...
for j = 1:length(mlp_list)
    mlp_type = mlp_list{j};
    accu = h5read(['/home/heehwan/Workspace/Data/ReduceFA_2015/revised_output/1117/' mlp_type '-' feature_type '.h5'], '/test_accu');
    err = h5read(['/home/heehwan/Workspace/Data/ReduceFA_2015/revised_output/1117/' mlp_type '-' feature_type '.h5'], '/test_err');
...
title('NLL of diffrent MLP structures with Gaussian layer')
xlabel('Epoch')
...
title('Accuracy of diffrent MLP structures with Gaussian layer')
xlabel('Epoch')
ylabel('Accuracy')
