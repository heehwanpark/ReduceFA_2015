...
cmd:option('-mimic2data', '/home/heehwan/Workspace/Data/ReduceFA_2015/cnndb_mimic2_overlapped.h5')
...
-- File name
cmd:option('-filename', '0910_result')
...
for i = 1, nTraining do
  ...
  elseif i > nSample_mimic2 and i <= nSample_mimic2 + nSample_mitdb then
    trainset_input[{i, {}}] = mitdb_input[{i, {}}]
    trainset_target[i] = mitdb_target[i]
  else
